...
MODEL                := fp_continuous_MIO_16E4_3
MODULES              := fp_continuous_MIO_16E4_3_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := fp_continuous_MIO_16E4_3.mk
...
#
MODELLIB                  := fp_continuous_MIO_16E4_3lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := fp_continuous_MIO_16E4_3_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;c:/users2/cee/e6/fp_continuous_MIO_16E4_3_sldrt_win32;c:/users2/cee/e6;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
