...
MODEL                := nointegrator
MODULES              := nointegrator_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := nointegrator.mk
...
#
MODELLIB                  := nointegratorlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := nointegrator_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;c:/users2/cee/e6/nointegrator_sldrt_win32;c:/users2/cee/e6;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
