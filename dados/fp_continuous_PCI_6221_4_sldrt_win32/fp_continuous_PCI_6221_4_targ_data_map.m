  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (fp_continuous_PCI_6221_4_P)
    ;%
      section.nData     = 20;
      section.data(20)  = dumData; %prealloc
      
	  ;% fp_continuous_PCI_6221_4_P.A
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% fp_continuous_PCI_6221_4_P.K
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 25;
	
	  ;% fp_continuous_PCI_6221_4_P.L
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 30;
	
	  ;% fp_continuous_PCI_6221_4_P.MOTOR_SAT
	  ...
	  ;% fp_continuous_PCI_6221_4_P.AnalogOutput1_FinalValue
	  ...
	  ;% fp_continuous_PCI_6221_4_P.EncoderInput_InputFilter
	  ...
	  ;% fp_continuous_PCI_6221_4_P.EncoderInput_MaxMissedTicks
	  section.data(13).logicalSrcIdx = 13;
	  section.data(13).dtTransOffset = 49;
	
	  ;% fp_continuous_PCI_6221_4_P.AnalogOutput1_MaxMissedTicks
	  section.data(14).logicalSrcIdx = 14;
	  section.data(14).dtTransOffset = 50;
	
	  ;% fp_continuous_PCI_6221_4_P.RealTimeSynchronization_MaxMissedTicks
	  section.data(15).logicalSrcIdx = 15;
	  section.data(15).dtTransOffset = 51;
	
	  ;% fp_continuous_PCI_6221_4_P.PIDController_P
	  section.data(16).logicalSrcIdx = 16;
	  section.data(16).dtTransOffset = 52;
	
	  ;% fp_continuous_PCI_6221_4_P.PIDController_UpperSaturationLimit
	  section.data(17).logicalSrcIdx = 17;
	  section.data(17).dtTransOffset = 53;
	
	  ;% fp_continuous_PCI_6221_4_P.EncoderInput_YieldWhenWaiting
	  section.data(18).logicalSrcIdx = 18;
	  section.data(18).dtTransOffset = 54;
	
	  ;% fp_continuous_PCI_6221_4_P.AnalogOutput1_YieldWhenWaiting
	  section.data(19).logicalSrcIdx = 19;
	  section.data(19).dtTransOffset = 55;
	
	  ;% fp_continuous_PCI_6221_4_P.RealTimeSynchronization_YieldWhenWaiting
	  ...
	  ;% fp_continuous_PCI_6221_4_P.AnalogOutput1_VoltRange
	  ...
	  ;% fp_continuous_PCI_6221_4_P.Zero1_Value
	  ...
	  ;% fp_continuous_PCI_6221_4_P.Bias_Bias
	  ...
	  ;% fp_continuous_PCI_6221_4_P.Selectang1_Gain
	  section.data(7).logicalSrcIdx = 31;
	  section.data(7).dtTransOffset = 7;
	
	  ;% fp_continuous_PCI_6221_4_P.Zero_Value
	  section.data(8).logicalSrcIdx = 32;
	  section.data(8).dtTransOffset = 9;
	
	  ;% fp_continuous_PCI_6221_4_P.Selectang2_Gain
	  ...
	  ;% fp_continuous_PCI_6221_4_P.Gain_Gain
	  ...
	  ;% fp_continuous_PCI_6221_4_P.Step_Y0
	  section.data(13).logicalSrcIdx = 37;
	  section.data(13).dtTransOffset = 15;
	
	  ;% fp_continuous_PCI_6221_4_P.Step_YFinal
	  section.data(14).logicalSrcIdx = 38;
	  section.data(14).dtTransOffset = 16;
	
	  ;% fp_continuous_PCI_6221_4_P.Timedelay_Threshold
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (fp_continuous_PCI_6221_4_B)
    ;%
      section.nData     = 9;
      section.data(9)  = dumData; %prealloc
      
	  ;% fp_continuous_PCI_6221_4_B.Bias
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% fp_continuous_PCI_6221_4_B.Bias3
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 2;
	  ...
	  ;% fp_continuous_PCI_6221_4_B.Gain
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 6;
	
	  ;% fp_continuous_PCI_6221_4_B.Timedelay
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 7;
	
	  ;% fp_continuous_PCI_6221_4_B.SumI1
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 9;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (fp_continuous_PCI_6221_4_DW)
    ;%
      section.nData     = 5;
      section.data(5)  = dumData; %prealloc
      
	  ;% fp_continuous_PCI_6221_4_DW.EncoderInput_PWORK
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% fp_continuous_PCI_6221_4_DW.AnalogOutput1_PWORK
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% fp_continuous_PCI_6221_4_DW.RealTimeSynchronization_PWORK
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% fp_continuous_PCI_6221_4_DW.angles_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% fp_continuous_PCI_6221_4_DW.AnglesradandControluV_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 4;
  ...
  targMap.checksum0 = 1212786068;
  targMap.checksum1 = 657300336;
  targMap.checksum2 = 4170352396;
  targMap.checksum3 = 4160496604;
