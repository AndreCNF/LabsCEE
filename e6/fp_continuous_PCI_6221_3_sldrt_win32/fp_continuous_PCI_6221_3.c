...
void fp_continuous_PCI_6221_3_output(void)
{
   ...
   */
  if (fp_continuous_PCI_6221_3_X.Integrator_CSTATE >
      fp_continuous_PCI_6221_3_P.Saturation_UpperSat) {
    rtb_Sum = fp_continuous_PCI_6221_3_P.Saturation_UpperSat;
  } else if (fp_continuous_PCI_6221_3_X.Integrator_CSTATE <
             fp_continuous_PCI_6221_3_P.Saturation_LowerSat) {
    rtb_Sum = fp_continuous_PCI_6221_3_P.Saturation_LowerSat;
  } else {
    rtb_Sum = fp_continuous_PCI_6221_3_X.Integrator_CSTATE;
  }
  ...
  fp_continuous_PCI_6221_3_B.TmpSignalConversionAtStateSpaceControllerInport1[0]
    ...
    fp_continuous_PCI_6221_3_B.Timedelay[0] + rtb_Sum;
...
RT_MODEL_fp_continuous_PCI_6221_3_T *fp_continuous_PCI_6221_3(void)
{
  ...
  /* External mode info */
  fp_continuous_PCI_6221_3_M->Sizes.checksums[0] = (272694203U);
  fp_continuous_PCI_6221_3_M->Sizes.checksums[1] = (447370076U);
  fp_continuous_PCI_6221_3_M->Sizes.checksums[2] = (3966762985U);
  fp_continuous_PCI_6221_3_M->Sizes.checksums[3] = (2897413010U);
  ...
  fp_continuous_PCI_6221_3_M->Sizes.numBlocks = (31);/* Number of blocks */
  fp_continuous_PCI_6221_3_M->Sizes.numBlockIO = (9);/* Number of block outputs */
  fp_continuous_PCI_6221_3_M->Sizes.numBlockPrms = (80);/* Sum of parameter "widths" */
